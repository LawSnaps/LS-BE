...
import { BackendUserRole, BackendUserRoleSchema } from '@app/schemas/backendUserRole.schema';
import { BackendUserRoleRepository } from '@app/repositories/backendUserRole.repository';


@Module({
    imports: [MongooseModule.forFeature([{ name: BackendUserRole.name, schema: BackendUserRoleSchema }])],
    controllers: [BackendUserRoleController],
    providers: [BackendUserRoleService,
