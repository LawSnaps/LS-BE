...
import { InvoiceTransaction, InvoiceTransactionSchema } from '@app/schemas/invoiceTransaction.schema';
import { InvoiceTransactionRepository } from '@app/repositories/invoiceTransaction.repository';


@Module({
    imports: [MongooseModule.forFeature([{ name: InvoiceTransaction.name, schema: InvoiceTransactionSchema }])],
    controllers: [InvoiceTransactionController],
    providers: [InvoiceTransactionService,
        { provide: 'invoiceTransactionModule', useClass: InvoiceTransactionRepository },
